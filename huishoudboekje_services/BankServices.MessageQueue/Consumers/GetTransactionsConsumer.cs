...
public class GetTransactionsConsumer(ITransactionService transactionServices, IConfiguration config)
  : IConsumer<GetTransactionMessage>
{
  public async Task Consume(ConsumeContext<GetTransactionMessage> context)
  {
    GetTransactionResponse result = new()
    {
      Data = await transactionServices.GetAll(context.Message.Filter)
    };
