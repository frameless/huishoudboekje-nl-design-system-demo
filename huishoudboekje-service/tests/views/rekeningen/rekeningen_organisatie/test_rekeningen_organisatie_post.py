...
def test_rekeningen_organisaties_post_realtion_already_exsists(client, rekening_organisatie_factory):
    """ Test /gebruikers/<object_id>/rekeningen/ path """
    ...
    assert response.json["errors"][0] == "Organisatie / Rekening relation already exsists."
