...
def get_grootboekrekeningen(req, _ctx):
...
def test_grootboekrekening_by_id(client):
    with requests_mock.Mocker() as mock:
        inkomsten_adapter = mock.get(
            f'{settings.GROOTBOEK_SERVICE_URL}/grootboekrekeningen/?filter_ids=m1',
