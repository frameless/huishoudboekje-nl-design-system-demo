...
class DeleteAfspraakBetaalinstructie(graphene.Mutation):
    ...
    class Arguments:
        ...
        betaalinstructie = graphene.Argument(lambda: Betaalinstructie, required=True)
    ...
    async def mutate(_root, _info, afspraak_id: int, betaalinstructie: Betaalinstructie):
        """ Update the Afspraak """
