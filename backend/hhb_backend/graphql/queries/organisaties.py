...
class OrganisatieQuery:
    ...
    async def resolver(cls, _root, _info, id):
        return hhb_dataloader().organisaties_by_id.load(id)
...
class OrganisatiesQuery:
    ...
    async def resolver(cls, _root, _info, ids=None):
        if ids:
            return hhb_dataloader().organisaties_by_id.load_many(ids)
        return hhb_dataloader().organisaties_by_id.load_all()
