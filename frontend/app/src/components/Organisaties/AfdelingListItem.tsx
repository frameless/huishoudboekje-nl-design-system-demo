...
const AfdelingListItem: React.FC<{afdeling: Afdeling}> = ({afdeling}) => {
	...
	return (
		<GridCard justify={["flex-start", "center"]} onClick={() => detailsModal.onOpen()} position={"relative"} as={NavLink} to={AppRoutes.Afdeling(String(afdeling.organisatie?.id), String(afdeling?.id))}>
