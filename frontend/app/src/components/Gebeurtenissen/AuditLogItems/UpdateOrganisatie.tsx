...
const UpdateOrganisatie: React.FC<{ g: GebruikersActiviteit }> = ({g}) => {
	...
	return <Trans i18nKey={"auditLog.updateOrganisatie"} values={data} components={{
...
export default UpdateOrganisatie;