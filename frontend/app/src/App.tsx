...
const App = () => {
  ...
  if (error) {
    return <StatusErrorPage error={error} />;
  }
    ...
    return (
      <TwoColumns>
        {loading ? (
          ...
          >
            <Heading size={"sm"}>
              {t("messages.welcome", { tenantName: theme.tenantName })}
            </Heading>
        ...
        <Box height={"100%"} minHeight={"100vh"} width={"100%"} p={5}>
          ...
          <Routes>
            <Route path={"/"} element={<Outlet />}>
              <Route
                index
                element={<Navigate to={RouteNames.huishoudens} replace />}
              />
              <Route path={RouteNames.huishoudens} element={<Outlet />}>
                ...
                <Route
                  path={RouteNames.overzicht}
                  element={<HuishoudenOverzichtIndex />}
                />
              </Route>
              <Route path={RouteNames.burgers} element={<Outlet />}>
                ...
                <Route
                  path={`:id/${RouteNames.personal}`}
                  element={<BurgerPersonalDetailsPage />}
                />
                <Route
                  path={`:id/${RouteNames.gebeurtenissen}`}
                  element={<BurgerAuditLogPage />}
                />
                <Route
                  path={`:id/${RouteNames.edit}`}
                  element={<EditBurger />}
                />
                <Route
                  path={`:id/${RouteNames.afspraken}/${RouteNames.add}`}
                  element={<CreateAfspraak />}
                />
              </Route>
              <Route path={RouteNames.afspraken} element={<Outlet />}>
                ...
                <Route
                  path={`:id/${RouteNames.edit}`}
                  element={<EditAfspraak />}
                />
                <Route
                  path={`:id/${RouteNames.betaalinstructie}`}
                  element={<BetaalinstructiePage />}
                />
                <Route
                  path={`:id/${RouteNames.followUp}`}
                  element={<FollowUpAfspraak />}
                />
                <Route
                  path={`:id/${RouteNames.copy}`}
                  element={<FollowUpAfspraak />}
                />
              </Route>
              <Route path={RouteNames.organisaties} element={<Outlet />}>
                ...
                <Route
                  path={`:id/${RouteNames.edit}`}
                  element={<EditOrganisatie />}
                />
                <Route
                  path={`:organisatieId/${RouteNames.afdelingen}/:id`}
                  element={<AfdelingDetailPage />}
                />
              </Route>
              <Route path={RouteNames.bankzaken} element={<Outlet />}>
                <Route
                  index
                  element={<Navigate to={RouteNames.transacties} replace />}
                />
                ...
                <Route
                  path={RouteNames.bankafschriften}
                  element={<CustomerStatementMessages />}
                />
                <Route path={RouteNames.betaalinstructies} element={<Outlet />}>
                  <Route index element={<Betaalinstructies />} />
                  <Route
                    path={RouteNames.add}
                    element={<CreateBetaalinstructies />}
                  />
                  <Route
                    path={`${RouteNames.exports}/:id`}
                    element={<ViewPaymentExport />}
                  />
                </Route>
              </Route>
              ...
              <Route
                path={RouteNames.gebeurtenissen}
                element={<Gebeurtenissen />}
              />
              <Route
                path={RouteNames.configuratie}
