...
See the [installation instructions here](readme/k8s_deploy_minikube.md).

### Production-like installation

To install Huishoudboekje in production, follow [these installation instructions](readme/k8s_build_and_deploy.md).
