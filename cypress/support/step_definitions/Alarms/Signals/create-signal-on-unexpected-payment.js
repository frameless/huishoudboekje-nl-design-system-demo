...
Given('a CAMT test file is created with a high payment amount', () => {
  ...
  // Create file
  cy.writeFile('cypress/testdata/paymentHigh.xml', `<?xml version='1.0' encoding='utf-8'?>
...
When('a high amount bank transaction is booked to an agreement', () => {
  ...
  cy.get('input[type="file"]')
    .selectFile('cypress/testdata/paymentHigh.xml', { force: true })
  cy.wait(3000);
...
Then('the bank transaction date is within the alarm timeframe', () => {
  ...
  cy.readFile('cypress/testdata/paymentHigh.xml').should('contains', todayDate);
...
Then('the high amount bank transaction amount is greater than the sum of the expected amount plus the allowed amount deviation', () => {
  ...
  cy.readFile('cypress/testdata/paymentHigh.xml').should('contains', '108.99');
...
Given('a CAMT test file is created with a low payment amount', () => {
  ...
  // Create file
  cy.writeFile('cypress/testdata/paymentLow.xml', `<?xml version='1.0' encoding='utf-8'?>
  <Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.053.001.02" xmlns_xsi="http://www.w3.org/2001/XMLSchema-instance">
      <BkToCstmrStmt>
          <GrpHdr>
              <MsgId>588d0a9f-439d-4410-8a3e-1354c2a9c55e</MsgId>
...
When('a low amount bank transaction is booked to an agreement', () => {
  ...
  cy.get('input[type="file"]')
    .selectFile('cypress/testdata/paymentLow.xml', { force: true })
  cy.wait(3000);
  cy.get('[aria-label="Close"]')
    .should('be.visible')
    .click();
...
//Then('the bank transaction date is within the alarm timeframe', () => {});
  ...
  Then('the low amount bank transaction amount is smaller than the sum of the expected amount minus the allowed amount deviation', () => {
    ...
    cy.readFile('cypress/testdata/paymentLow.xml').should('contains', '7.99');
...
Given('a CAMT test file is created with an expected payment amount', () => {
  ...
  // Create file
  cy.writeFile('cypress/testdata/paymentExpected.xml', `<?xml version='1.0' encoding='utf-8'?>
  <Document xmlns="urn:iso:std:iso:20022:tech:xsd:camt.053.001.02" xmlns_xsi="http://www.w3.org/2001/XMLSchema-instance">
      <BkToCstmrStmt>
          <GrpHdr>
              <MsgId>588d0a9f-439d-4410-8a3e-1354c2a9c55e</MsgId>
...
When('an expected amount bank transaction is booked to an agreement', () => {
  ...
  cy.get('input[type="file"]')
    .selectFile('cypress/testdata/paymentExpected.xml', { force: true })
  cy.wait(3000);
  cy.get('[aria-label="Close"]')
    .should('be.visible')
    .click();
...
//Then('the bank transaction date is within the alarm timeframe', () => {});
  ...
  Then('the bank transaction amount is smaller than the sum of the expected amount plus the allowed amount deviation or greater than the sum of the expected amount minus the allowed amount deviation', () => {
    ...
    cy.readFile('cypress/testdata/paymentExpected.xml').should('contains', '10.99');
