...
class JournaalpostenFilterView(BasicFilterView):
    ...
    def add_filter_options(self, filter_options, query):
        ...
        transation_ids = filter_options.get("transation_ids", None)
        ...
        if transation_ids is not None:
            new_query = new_query.filter(Journaalpost.transaction_id.in_(transation_ids))
