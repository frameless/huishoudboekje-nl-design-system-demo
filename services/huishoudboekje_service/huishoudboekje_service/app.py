...
from huishoudboekje_service.views import (
    ...
    HuishoudenView,
    AfdelingView,
    BurgerAfsprakenTransactiesView
)
...
def create_app(config_name='huishoudboekje_service.config.Config'):
    ...
    routes = [
        ...
        {"path": "/burgers/<burger_id>/transacties", "view": BurgerAfsprakenTransactiesView, "name": "burger_transacties"},
        ...
        {"path": "/transacties_journaalpost_rubriek", "view": JournaalpostRubriekView, "name": "journaalpost_rubriek_view"},
