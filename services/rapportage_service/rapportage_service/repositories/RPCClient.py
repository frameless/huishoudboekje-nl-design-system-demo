...
import uuid
import pika
from rapportage_service.repositories.settings import RABBBITMQ_PASS, RABBBITMQ_USER, RABBBITMQ_HOST, RABBBITMQ_PORT
...
class RpcClient(object):
    ...
    def __init__(self, routing_key):
        ...
        self.callback_queue = f'rapportage-transactions-response-{str(uuid.uuid4())}'
