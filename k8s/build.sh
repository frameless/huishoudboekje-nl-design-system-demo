...
export KEYCLOAK_CLIENT_USERS=${KEYCLOAK_CLIENT_USERS:-"dirkverbeek,dirk.verbeek@topicus.nl,Dirk,Verbeek,demo:koenbrouwer,koen@openweb.nl,Koen,Brouwer,demo:baukehuijbers,bauke.huijbers@vng.nl,Bauke,Huijbers,demo:henkpoortvliet,henk.poortvliet@sloothuizen.nl,Henk,Poortvliet,demo:huishoudboekje010,huishoudboekje010@rotterdam.nl,Gemeente,Rotterdam,demo:huishoudboekje030,huishoudboekje@utrecht.nl,Gemeente,Utrecht,demo"}
